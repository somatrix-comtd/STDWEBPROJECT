...
<span>Student ID: </span><input type="text" style="width:265px; height:30px;"  value="SLM-<?php 
...
<span>Phone Number: </span><input type	="text" style="width:265px; height:30px;" name="parent" required />
<br>
